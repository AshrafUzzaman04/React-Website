    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <div>
          ...
          <a className="link link-hover">Dental Bonding</a>
          <a className="link link-hover">Dental Crowns</a>
          <a className="link link-hover">Bridgework</a>
          <a className="link link-hover">Invisalign</a>
        </div>
        <div>
      ...
      <footer className="footer footer-center p-4 bg-base-300 text-base-content">
        <div>
          <p>Copyright © 2022 - All right reserved by Ashraf Uz Mahim</p>
        </div>
      </footer>
    </div>
  );
